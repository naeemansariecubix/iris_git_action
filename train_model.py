...
# Select Features (correct the repeated 'petal_legth_width_ratio')
...
labels = dataset.columns[:-1]  # Exclude 'target' from feature names
...
# Write model scores to report.txt
